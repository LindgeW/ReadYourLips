...
class AVHuBERT(nn.Module):   # adapted from https://github.com/facebookresearch/av_hubert/blob/258fb50e155134eec2c4b49c2ae8de267075fd18/avhubert/hubert.py#L335
    def __init__(
        self,
        cfg,
    ):
        ...
        resnet = ResEncoder(
            relu_type=cfg.resnet_relu_type, weights=cfg.resnet_weights, cfg=cfg
        )
